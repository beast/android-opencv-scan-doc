//
// Created by yang yao on 29/08/2016.
//

#include "com_example_yangyao_android_opencv_OpenCVHelper.h"
...
JNIEXPORT jstring JNICALL Java_com_example_yangyao_android_1opencv_OpenCVHelper_crop
  (JNIEnv * env, jclass obj, jstring filePath){
//    string img_path[] = {"images/doc3.jpg"};
//    scan(img_path[0]);
//    string c_str = (env)->GetStringUTFChars(filePath, NULL);
//    printf("string: %s", c_str);

    string path = "/storage/emulated/0/DCIM/Camera/IMG_20160829_094251.jpg";
    scan(path);

    return (env)->NewStringUTF("cropping completed");
  }
